...
import com.api.common.core.domain.entity.SysUser;
...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult authRole(@PathVariable("userId") Long userId)
    {
        ...
        ajax.put("user", user);
        ajax.put("roles", userService.selectRolePermissionByUserId(userId));
        return ajax;
    }
    ...
    @PutMapping("/authRole")
    public AjaxResult insertAuthRole(@RequestBody Long userId, Long[] roleIds)
    {
        userService.checkUserDataScope(userId);
    ...
    {
        List<SysDept> depts = userService.selectDeptTree(dept);
